...
import com.dizimaster.model.Grafico;

public class LblGrafico extends JComponent {

    private static final long serialVersionUID = 1L;
	private final List<Grafico> models;
    ...
    public void addData(Grafico data) {
        models.add(data);
    }
